...
class RailDriver
{
    ...
    [DllImport("raildriver.dll")]
    public static extern RDid GetRailDriverGetId();
    [DllImport("raildriver.dll")]
    public static extern RDmod GetRailDriverGetType();
    [DllImport("raildriver.dll")]
    public static extern void SetRailDriverValue(RDid id, float value);
    [DllImport("raildriver.dll")]
    public static extern void SetRailDriverLocoChanged(bool combinedThrottleAndBrake);
}
